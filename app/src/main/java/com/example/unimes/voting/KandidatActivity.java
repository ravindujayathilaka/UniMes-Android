...
public class KandidatActivity extends AppCompatActivity {
                            ...
                            database.child("group").addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    for (DataSnapshot item : snapshot.getChildren()) {
                                        com.budyfriend.daterangepickerfirebase.dataKandidat kandidat = item.getValue(com.budyfriend.daterangepickerfirebase.dataKandidat.class);
                                        if (kandidat != null) {
    ...
    ArrayList<com.budyfriend.daterangepickerfirebase.dataKandidat> dataKandidatArrayList = new ArrayList<>();
