...
public class AdapterKandidat extends RecyclerView.Adapter<AdapterKandidat.KandidatViewHolder> {
    ArrayList<com.budyfriend.daterangepickerfirebase.dataKandidat> dataKandidatArrayList;
    Context context;
    ...
    public class KandidatViewHolder extends RecyclerView.ViewHolder {
        ...
        public void viewBind(final com.budyfriend.daterangepickerfirebase.dataKandidat dataKandidat) {
