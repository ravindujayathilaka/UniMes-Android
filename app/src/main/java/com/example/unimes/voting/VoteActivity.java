...
public class VoteActivity extends AppCompatActivity {
    ...
    com.budyfriend.daterangepickerfirebase.AdapterVote adapterVote;
    ...
    private void showData() {
        ...
        database.child("group").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapterVote = new com.budyfriend.daterangepickerfirebase.AdapterVote(dataKandidatArrayList,context);
